...
export const PANEL_IDS = ['A1', 'A2', 'A3', 'EC', 'S2P', 'MOCK', 'B1', 'B2', 'B3', 'B4',
  'S1S', 'OB', 'TP', 'CVD', 'HM', 'IA', 'C1', 'C2', 'C4', 'MODE'] as const
...
function builtins(): Workspace[] {
  return [
    ...
    { id: 'micro', name: 'MICRO · S1', builtin: true, showBlotter: true,
      columns: [['S1S', 'B2', 'IA'], ['B4', 'OB', 'CVD', 'HM', 'B1'], ['TP', 'EC', 'B3', 'C1', 'C2', 'MOCK']] },
...
// v7 : ajout du panneau HM (Heatmap de liquidité, D-036) à l'espace MICRO — bump de clé : les
...
const STORAGE_KEY = () => `cholismo.workspaces.${useTerminal.getState().operator}.v7`
