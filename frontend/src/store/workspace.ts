...
export const PANEL_IDS = ['A1', 'A2', 'A3', 'EC', 'MCAL', 'S2P', 'SENT', 'YLD', 'MOCK', 'B1', 'B2', 'B3', 'B4',
...
function builtins(): Workspace[] {
  return [
    ...
    { id: 'macro', name: 'MACRO · S2', builtin: true, showBlotter: false,
      columns: [['A1', 'YLD', 'A3', 'SENT', 'EC', 'VTS'], ['S2P', 'A2', 'OMON'], ['B4', 'B3', 'MOCK']] },
    { id: 'discipline', name: 'DISCIPLINE', builtin: true, showBlotter: true,
      columns: [['C5', 'C1', 'C2'], ['B4', 'C4'], ['MODE', 'MOCK']] },
  ]
}

// v13 : ajout des panneaux SENT (positionnement Long/Short) et YLD (taux & différentiels,
// D-053) à l'espace MACRO — bump de clé : les layouts persistés antérieurs repartent des intégrés (les PERSO se recréent ; pas de
